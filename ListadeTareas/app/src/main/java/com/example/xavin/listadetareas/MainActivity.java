package com.example.xavin.listadetareas;
    ...
    private class TaskAdapter extends ArrayAdapter<ListEntry> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (listEntry.importance) {
                case 1:
                    icon.setImageResource(R.drawable.ic_green_web);
                    break;
                case 2:
                    icon.setImageResource(R.drawable.ic_yellow_web);
                    break;
                default:
                    icon.setImageResource(R.drawable.ic_red_web);
                    break;
            }
            return row;
        }
